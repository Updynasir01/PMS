  ...
  return (
    <div className="flex h-screen overflow-hidden surface-page">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <header className="relative z-40 h-16 border-b-[0.5px] border-border bg-page/90 backdrop-blur-md flex items-center justify-between px-edge flex-shrink-0">
        ...
        <main className="relative z-0 flex-1 overflow-y-auto p-edge lg:p-8">
          {children}
        </main>
      </div>
